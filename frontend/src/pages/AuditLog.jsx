...
export default function AuditLog() {
  ...
  return (
    <div>
      ...
      <div className="p-6">
        {items.length === 0 && <div className="text-sm text-neutral-500">No audit entries yet.</div>}
            ...
            <tbody>
              {items.map((e) => (
                <tr key={e.id} className="border-b border-line last:border-b-0">
                  ...
                  <td className="p-3 font-mono text-xs text-neutral-600 truncate max-w-md">{JSON.stringify(e.meta)}</td>
                </tr>
              ))}
            </tbody>
          </table>
