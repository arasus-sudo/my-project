  ...
  return (
    <div>
      ...
      <div className="p-6 space-y-6">
        {kpis.sent === 0 && (
          <div className="card-flat p-4 flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-neutral-500">Seed sample leads, a mailbox and a Q1 outreach campaign.</div>
            </div>
        ...
        {/* KPIs */}
        <div className="grid grid-cols-2 md:grid-cols-5 gap-0 border border-line">
          {[
            ...
            <div key={c.k} className={`p-6 bg-white ${i > 0 ? "border-l border-line" : ""}`}>
              <div className="ui-label">{c.k}</div>
              <div className="font-mono text-4xl font-bold mt-2 tracking-tighter">{c.v}</div>
              {c.sub && <div className="text-xs text-neutral-500 mt-1 font-mono">{c.sub}</div>}
            </div>
          ))}
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="md:col-span-2 card-flat p-6">
            ...
            <div className="mt-3 flex gap-5 text-xs font-mono text-neutral-500 uppercase">
          ...
          <div className="grid grid-cols-4 gap-2">
            {[
              ...
              <div key={s.k}>
                ...
                <div className="font-mono text-3xl font-bold mt-1">{s.v}</div>
