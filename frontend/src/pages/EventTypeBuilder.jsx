        ...
        <div className="flex gap-1 border-b border-line mb-6 overflow-x-auto">
          {tabs.map((t) => (
            <button key={t.key} onClick={() => setTab(t.key)}
              className={`px-4 py-2 text-body font-medium font-display border-b-2 transition-colors whitespace-nowrap shrink-0 ${tab === t.key ? 'border-ink text-ink' : 'border-transparent text-ink-muted hover:text-ink'}`}>
              {t.label}
            </button>
          ))}
        </div>
          ...
          <div className="max-w-2xl space-y-6">
            <div className="shadow-card rounded-2xl p-6 sm:p-8 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <div className="text-card-title font-display font-semibold">Booking page appearance</div>
              </div>
          ...
          <div className="max-w-2xl space-y-6">
            ...
            <div className="shadow-card rounded-2xl p-6 sm:p-8 space-y-3">
              <div className="flex items-center gap-2">
                ...
                <div className="text-card-title font-display font-semibold">Custom form fields</div>
                <span className="text-tiny text-ink-muted">Shown on the booking form</span>
              </div>
              <div className="space-y-2">
                {(et.form_fields || []).map((f, i) => (
                  <div key={i} className="flex flex-col sm:flex-row gap-2 items-start sm:items-center p-2 bg-neutral-50 rounded-lg">
                    ...
                    <label className="flex items-center gap-1 text-caption whitespace-nowrap">
                    ...
                    <button onClick={() => patch("form_fields", et.form_fields.filter((_, x) => x !== i))}
                      className="text-ink-muted hover:text-danger shrink-0"><Trash2 size={14} /></button>
                  </div>
                ))}
              </div>
            ...
            <div className="shadow-card rounded-2xl p-6 sm:p-8 space-y-3">
              <div className="text-card-title font-display font-semibold">Qualifying questions</div>
              <p className="text-caption text-ink-muted">Asked before the calendar is shown; answers are scored 0-100 and can route low-fit guests elsewhere.</p>
              <div className="space-y-2">
          ...
          <div className="max-w-2xl space-y-6">
            <div className="shadow-card rounded-2xl p-6 sm:p-8 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <div className="text-card-title font-display font-semibold">Email notifications</div>
              </div>
              <label className="flex items-center gap-2 text-body">
            ...
            <div className="shadow-card rounded-2xl p-6 sm:p-8 space-y-4">
              <div className="flex items-center gap-2">
                <Clock size={14} className="text-ink" />
                <div className="text-card-title font-display font-semibold">Reminder timing</div>
              </div>
              <label className="flex items-center gap-2 text-body">
              ...
              <div>
                <label className="form-label block mb-1">Send reminder(s) X minutes before</label>
                <div className="space-y-2">
            ...
            <div className="shadow-card rounded-2xl p-6 sm:p-8 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <div className="text-card-title font-display font-semibold">Webhook</div>
              </div>
              <div>
