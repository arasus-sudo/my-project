  ...
  return (
    <div className="card-flat shadow-card p-6 space-y-3" data-testid="brand-voice-section">
      <div>
        ...
        <div className="text-caption text-ink-muted mt-0.5">Tune the assistant&apos;s tone for cold emails and carousel copy.</div>
      </div>
      <div className="text-body text-ink-tertiary">
